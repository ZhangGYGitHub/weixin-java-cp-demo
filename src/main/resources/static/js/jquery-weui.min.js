...
$(function(){
	...
	$("body").after('<script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.4.0.js"></script>');
	$("body").after('<script src="' + localhostPaht + '/res/js/wechat-share.js"></script>');
});